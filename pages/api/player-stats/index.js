...
export default async function handler(req, res) {
  ...
  try {
    ...
    const playerStats = players.map((player) => {
      ...
      let longestWinStreak = getLongestWinStreak(matches, playerIdString);
      let longestLoseStreak = getLongestLoseStreak(matches, playerIdString);

      let bonusPoints = 0;
      // let bonusPoints = getBonusForStreak(matches, playerIdString);
